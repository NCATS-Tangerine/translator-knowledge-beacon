...
* [Semantic Medline Database Beacon](now uses code from https://github.com/NCATS-Tangerine/tkg-beacon): a Java Spring Boot KBAPI accessing a Neo4j server containing [Semantic Medline Database](https://skr3.nlm.nih.gov/) concepts and relationships text-mined from PubMed abstracts. Beacon deployed at https://kba.ncats.io/beacon/rkb.(note, thie beacon may soon be reconfigured to resolved as https://kba.ncats.io/beacon/semmeddb).
* [Monarch Database "Biolink" Beacon](now uses code from https://github.com/NCATS-Tangerine/tkg-beacon): a Python KBAPI accessing the Monarch Biolink API of the [Monarch Initiative Biomedical Resource](https://monarchinitiative.org/). Beacon deployed at https://kba.ncats.io/beacon/biolink.
* [HMBD Database](http://www.hmdb.ca; code at https://github.com/NCATS-Tangerine/HMDB-knowledge-beacon). Human Metabolome database wrapped as a beacon (beacon by Vlado Dancik, Broad). Beacon deployed at https://translator.ncats.io/hmdb-knowledge-beacon.
...
* [RTX Knowledge Graph Beacon](http://www.hmdb.ca/; beacon uses code from https://github.com/NCATS-Tangerine/tkg-beacon). NCATS RTX team implementation of the Translator Knowledge Graph. Beacon deployed at https://kba.ncats.io/beacon/rtx. 
